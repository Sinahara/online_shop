...
<header>
    ...
    <div class="announcement-bar" role="region" aria-label="Announcement">
        ...
        <nav>
            <div class="nav-item">
                <a class="nav-link" class="nav-link active" href="home.php"><b>Beranda</b></a>
            </div>
            <div class="nav-item">
            ...
            <div class="nav-item" class="container">
                <div class="nav-link" class="nav-link active" class="search-box">
                    ...
                    <form method="GET" action="home.php" class="search-form">
                        <input placeholder="Search" id="search" autocomplete="off" type="text" name="kata_cari" value="<?php if(isset($_GET['kata_cari'])) { echo $_GET['kata_cari']; } ?>" />
                        <?php
                        ...
                        include('koneksi.php');
                          ...
                          if(isset($_GET['kata_cari'])){
                            ...
                            $query = "SELECT * FROM produk WHERE harga_produk like '%".$kata_cari."%' OR nama_produk like '%".$kata_cari."%' OR keterangan like '%".$kata_cari."%' ORDER BY id ASC";
                          } else {
...
<body>
    ...
    <div class="wrapper">
        ...
        <img height="420" width="327" src="gambar/<?php echo $row['gambar']; ?>.png">
        </div>
        <div class="product-info">
        <div class="product-text">
            <h1><a href="produk/<?php echo $row['tombol']; ?>.php"><?php echo $row['nama_produk']; ?></a></h1>
            <h2>by Ani-Shop</h2>
            <p><?php echo $row['keterangan']; ?></p>
        </div>
        <div class="product-price-btn">
            <p><!-- <strike>Rp125K</strike> untuk promo --><?php echo $row['harga_produk']; ?></p>
            <a href="#open-modal"><button type="button">buy now</button></a>
              <!-- Pop Up -->
              <div id="open-modal" class="modal-window">
                <div>
                  ...
                  <div>Silahkan login terlebih dahulu untuk mengakses konten</div>
                </div>
              </div>
              <!-- Pop Up selesai -->
        </div>
...
<footer class="footer">
  <div class="footer__addr">
    ...
    <address>
      Kemantren KM 10, Rejoso, Kab. Pasuruan<br>
          
      <a class="footer__btn" href="abdeeachmad@gmail.com">Email Us</a>
    </address>
  </div>
